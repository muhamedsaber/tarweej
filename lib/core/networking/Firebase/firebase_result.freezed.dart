...
mixin _$FirebaseResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(FirebaseErrorModel model) error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(FirebaseErrorModel model)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$FirebaseResultCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'FirebaseResult<$T>.error(model: $model)';
  }
...
abstract class Error<T> implements FirebaseResult<T> {
  factory Error(final FirebaseErrorModel model) = _$ErrorImpl<T>;
